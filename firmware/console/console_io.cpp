 ...
 *    We have two halves of DMA buffer - one is used for TTL while gerEFI prepares next batch of data in the other side.
 ...
 *    we have custom gerEFI changes to ChibiOS HAL driver v1
 *    F7 uses driver v2 which currently does not have gerEFI changes.
