...
#ifdef GEREFI_STM32_LSE_WAIT_MAX_RTCSEL
		efiPrintf("GEREFI_STM32_LSE_WAIT_MAX_RTCSEL=%d %s",
			GEREFI_STM32_LSE_WAIT_MAX_RTCSEL >> STM32_RTCSEL_SHIFT, rtcsel_names[GEREFI_STM32_LSE_WAIT_MAX_RTCSEL >> STM32_RTCSEL_SHIFT]);
#endif
	}
#endif
