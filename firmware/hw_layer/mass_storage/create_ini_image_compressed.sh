...
# hw_layer/mass_storage/create_ini_image_compressed.sh tunerstudio/generated/gerefi.ini hw_layer/mass_storage/ramdisk_image.h  1024 test https://gerefi.com/s/test
