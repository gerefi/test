...
COMMON_GEN_CONFIG="
 ...
 -java_destination ../java_console/models/src/main/java/com/gerefi/config/generated/ \
 ...
 -prepend integration/gerefi_config_trigger.txt \
 ...
 -prepend integration/gerefi_config_shared.txt \
 -board ${BOARD_DIR}"
