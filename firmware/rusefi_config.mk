...
INI_FILE = $(PROJECT_DIR)/$(META_OUTPUT_ROOT_FOLDER)tunerstudio/generated/gerefi_$(SHORT_BOARD_NAME).ini
SIG_FILE = $(PROJECT_DIR)/$(META_OUTPUT_ROOT_FOLDER)tunerstudio/generated/signature_$(SHORT_BOARD_NAME).txt

CONFIG_INPUTS = \
  $(SIG_FILE) \
  $(PROJECT_DIR)/controllers/algo/gerefi_hw_stm32_enums.h \
  $(PROJECT_DIR)/controllers/algo/gerefi_hw_adc_enums.h \
...
CONFIG_FILES = \
  $(INI_FILE) \
  $(PROJECT_DIR)/$(META_OUTPUT_ROOT_FOLDER)controllers/generated/gerefi_generated_$(SHORT_BOARD_NAME).h \
