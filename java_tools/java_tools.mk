...
TS_PLUGIN_LAUNCHER_JAR = $(JAVA_TOOLS)/ts_plugin_launcher/build/jar/gerefi_ts_plugin_launcher.jar
CONSOLE_JAR = $(PROJECT_DIR)/../console/gerefi_console.jar
AUTOUPDATE_JAR = $(PROJECT_DIR)/../console/gerefi_autoupdate.jar
